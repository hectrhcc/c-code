/*Un programa que pida al usuario que teclee frases, y las almacene en el archivo
“frases.txt”. Acabará cuando el usuario pulse Intro sin teclear nada. Después 
deberá mostrar el contenido del archivo.*/
